...
const paths: Record<AmbienceLayerId, ReactNode> = {
  ...
  cafe: (
    <>
      <path d="M5.5 10h11v4.5a4 4 0 0 1-4 4h-3a4 4 0 0 1-4-4V10z" />
      <path d="M16.5 11h1.8a2.2 2.2 0 0 1 0 4.4h-1" />
      <path d="M8.5 4.5c-.6 1 .4 1.6 0 2.6M12 4c-.6 1 .4 1.6 0 2.6" />
    </>
  ),
  typing: (
    <>
